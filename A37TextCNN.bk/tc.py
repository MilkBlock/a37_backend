...
from A37TextCNN.TextCNN import TextCNNModel
...
def init_model():
    ...
    with open('./static/A37TextCNN/word_2_index_2.json', 'r', encoding='utf-8') as f:
    ...
    model.load_state_dict(torch.load('./static/A37TextCNN/text_cnn_model_2.pth'))
